...
/**
    @title OrgOp_Access_OnlyParticipant
 */
abstract contract OnlyParticipant is
    OrgOpBase
{
    // error YouAreNotMember();
    /**
        !!! Warning !!!
    ...
    error YouAreNotParticipant();

    modifier onlyParticipant() { // TODO
        // if (!isMember(msg.sender)) revert YouAreNotParticipant();
        _;
    }
